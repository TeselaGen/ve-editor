...
var InfiniteScoller = (_temp2 = _class = function (_React$Component) {
  ...
  function InfiniteScoller() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.scrollTo = function (row) {
      ...
      var infiniteContainer = _reactDom2.default.findDOMNode(_this.refs.infiniteContainer);
      ...
      var visibleRowsContainer = _reactDom2.default.findDOMNode(_this.refs.visibleRowsContainer);
      ...
      var totalNumberOfRows = (0, _validate2.default)([newTotalNumberOfRows]) ? newTotalNumberOfRows : _this.props.totalNumberOfRows;
      ...
      if (!(0, _validate2.default)([_this.rowStart, _this.rowEnd])) {
      ...
      return _reactDom2.default.findDOMNode(_this.refs.visibleRowsContainer);
...
process.env.NODE_ENV !== "production" ? InfiniteScoller.propTypes = {
  averageElementHeight: _propTypes2.default.number,
  containerHeight: _propTypes2.default.number.isRequired,
  totalNumberOfRows: _propTypes2.default.number.isRequired,
  renderRow: _propTypes2.default.func.isRequired,
  rowToJumpTo: _propTypes2.default.shape({
    row: _propTypes2.default.number
  }),
  style: _propTypes2.default.object,
  jumpToBottomOfRow: _propTypes2.default.bool,
