...
var _moveCaret = require('../VectorInteractionWrapper/moveCaret');

var _moveCaret2 = _interopRequireDefault(_moveCaret);

var _handleCaretMoved = require('../VectorInteractionWrapper/handleCaretMoved');

var _handleCaretMoved2 = _interopRequireDefault(_handleCaretMoved);
...
var RowView = (_temp = _class = function (_React$Component) {
  ...
  RowView.prototype.getNearestCursorPositionToMouseEvent = function getNearestCursorPositionToMouseEvent(rowData, event, callback) {
    ...
    (0, _some2.default)(visibleRowsContainer.childNodes, function (rowDomNode) {
  ...
  RowView.prototype.componentDidMount = function componentDidMount() {
    ...
    self.combokeys = new _combokeys2.default(self.rowViewComp);
    ...
    moveCaretBindings.forEach(function (_ref) {
      ...
      self.combokeys.bind(keyCombo, function (event) {
        ...
        var moveBy = (0, _moveCaret2.default)({ sequenceLength: sequenceLength, bpsPerRow: bpsPerRow, caretPosition: caretPosition, selectionLayer: selectionLayer, shiftHeld: shiftHeld, type: type });
        (0, _handleCaretMoved2.default)({
          moveBy: moveBy,
          circular: circular,
  ...
  RowView.prototype.render = function render() {
    ...
    var rowData = (0, _prepareRowData2.default)(sequenceData, bpsPerRow);
