...
var _generateRandomRange = require('ve-range-utils/generateRandomRange');

var _generateRandomRange2 = _interopRequireDefault(_generateRandomRange);
...
function generateAnnotation(start, stop, maxLength) {
    var range = (0, _generateRandomRange2.default)(start, stop, maxLength);
